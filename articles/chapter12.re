...
バックログをはじめ、スクラムを通じて作成していく各種のアーティファクトについて、私たちは当初、書籍などに記載されている標準的なものを利用していました。
...
このため、私たちはスクラムに則って活動するなかで見えてきた問題意識も踏まえて、活動全体を管理するためのツールを自分たち自身で創り上げることにし、そのために必要な要素について話し合いました。
...
そのような活動の結果取り入れたり自ら作成したりしてきたものは多岐に渡っており、バーンダウンチャートの自動可視化ツール、Google Meetで使えるポモドーロタイマー、GitHubコメント集計ツール、週報DB書き出しツール、Google Meetコメントフローツール、学習指標データベースなど、多くのものがあります。

これらの取り組みのように、目詰まりを起こしているプロセスをツールの改善によって見直しをするやり方は、改善策をより具体的なものにする良さを持っていたように思います。
例えば「レトロスペクティブはもっと『わいわい』やっていこう」という改善方針を立てたことがありました。こうした方針は、それだけでは曖昧な心がけになりかねないところがあります。しかしながら、単に心持ちとしてそういう姿勢で臨もうという話にとどめず、Google Meet上でニコニコ動画のようにコメントが流れていくツールを取り入れて場の雰囲気を演出したり、カジュアルなスタンプ表示の機能を備えるボードツールを使いつつ、各スタンプにそれぞれの意思を割り当てるルールをつくり、話しているメンバーに対してゆるめな雰囲気で意思表示できるようにするといった工夫は、ささやかなものではありますが、単に「わいわい」やっていこうという心持ちを確認しあうだけの場合と比べて、はるかに具体的な行動に結実しやすい工夫でした。

このバックログもモブプロの知識体系化記録や学習目標の達成度データベースと一体化させることで、開発活動を学びに繋げていく工夫を具体化する効果をもたらしました。

こうして、プロダクトだけでなくプロセスを支えるツールについてもインクリメンタルに改善を重ねることで、ツールの不便解消だけにとどまらず、活動そのものを改善していくことに繋がっていきました。