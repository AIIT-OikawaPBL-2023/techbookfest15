...
フルタイムの仕事を別途持つ私たちのスクラムメンバーは、毎日デイリースクラムを行うことが現実的ではないため、毎日ではなく週3回のコアミーティングの冒頭15分間を利用してデイリースクラムを行っています。
...
PLB活動で実施したふりかえりの大まかな流れは下記になります。「１．アイスブレークを実施する」以外は、ふりかえり本に記してある流れを取り入れています。
